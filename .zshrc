...
alias mirror="sudo reflector -f 10 -l 30 --number 10 --verbose --save /etc/pacman.d/mirrorlist"
...
alias gps="git push git@gitlab.com:amogh_mav/mydotfiles.git"
 alias gpu="git pull git@gitlab.com:amogh_mav/mydotfiles.git"
alias gcm="git commit -m"
##  RANDOM COLOR SCRIPT ##
colorscript -r
#Keychain to add my ssh keys
